...
// from fields : name, page, description, image
  ...
  return (
        <div className="max-w-[600px] w-full">
          ...
          <form className="mt-4" onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="block w-full font-bold mb-2" htmlFor="description">
            Description:
              </label>
              <textarea
            id="description"
            ...
            <div className="mb-4">
              <label className="block w-full font-bold mb-2" htmlFor="image">
            Image:
              </label>
              <input
            type="text"
